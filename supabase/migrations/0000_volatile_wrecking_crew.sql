...
ALTER TABLE "root_accounts" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "business_cards" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "alliances" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
CREATE TABLE "works" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"title" text NOT NULL,
	"author" text,
...
--> statement-breakpoint
ALTER TABLE "market_items" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "market_transactions" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "nation_events" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "nation_posts" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "nation_groups" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "nation_citizens" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "nation_event_participants" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "user_work_ratings" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "user_work_entries" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
ALTER TABLE "root_accounts" ADD CONSTRAINT "root_accounts_auth_user_id_fkey" FOREIGN KEY ("auth_user_id") REFERENCES "auth"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "works" ADD CONSTRAINT "works_owner_user_id_fkey" FOREIGN KEY ("owner_user_id") REFERENCES "auth"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_work_ratings" ADD CONSTRAINT "user_work_ratings_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_work_entries" ADD CONSTRAINT "user_work_entries_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_works_owner_status" ON "works" USING btree ("owner_user_id" text_ops,"status" text_ops);--> statement-breakpoint
...
CREATE POLICY "Users can update own root account" ON "root_accounts" AS PERMISSIVE FOR UPDATE TO public USING ((auth.uid() = auth_user_id));--> statement-breakpoint
CREATE POLICY "Users can view own root account" ON "root_accounts" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
CREATE POLICY "Users can delete own profiles" ON "user_profiles" AS PERMISSIVE FOR DELETE TO public USING ((root_account_id IN ( SELECT root_accounts.id
   FROM root_accounts
  WHERE (root_accounts.auth_user_id = auth.uid()))));--> statement-breakpoint
CREATE POLICY "Users can update own profiles" ON "user_profiles" AS PERMISSIVE FOR UPDATE TO public;--> statement-breakpoint
CREATE POLICY "Users can insert own profiles" ON "user_profiles" AS PERMISSIVE FOR INSERT TO public;--> statement-breakpoint
CREATE POLICY "Users can view own profiles" ON "user_profiles" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
CREATE POLICY "Owners can create their own business card" ON "business_cards" AS PERMISSIVE FOR INSERT TO public WITH CHECK ((EXISTS ( SELECT 1
   FROM (user_profiles
     JOIN root_accounts ON ((user_profiles.root_account_id = root_accounts.id)))
  WHERE ((user_profiles.id = business_cards.user_profile_id) AND (root_accounts.auth_user_id = auth.uid())))));--> statement-breakpoint
CREATE POLICY "Owners can update their own business card" ON "business_cards" AS PERMISSIVE FOR UPDATE TO public;--> statement-breakpoint
CREATE POLICY "Public can view published business cards" ON "business_cards" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
CREATE POLICY "Owners can view their own business card" ON "business_cards" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
CREATE POLICY "Users can delete their own profiles' alliances" ON "alliances" AS PERMISSIVE FOR DELETE TO public USING (((profile_a_id IN ( SELECT user_profiles.id
   FROM user_profiles
  ...
  WHERE (user_profiles.root_account_id IN ( SELECT root_accounts.id
           FROM root_accounts
          WHERE (root_accounts.auth_user_id = auth.uid())))))));--> statement-breakpoint
CREATE POLICY "Users can update their own profiles' alliances" ON "alliances" AS PERMISSIVE FOR UPDATE TO public;--> statement-breakpoint
CREATE POLICY "Users can initiate alliances for their own profiles" ON "alliances" AS PERMISSIVE FOR INSERT TO public;--> statement-breakpoint
CREATE POLICY "Users can view their own profiles' alliances" ON "alliances" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
CREATE POLICY "Users can view their own pending/private works" ON "works" AS PERMISSIVE FOR SELECT TO public USING ((auth.uid() = owner_user_id));--> statement-breakpoint
CREATE POLICY "Public works are viewable by everyone" ON "works" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
CREATE POLICY "Users can update their own works" ON "works" AS PERMISSIVE FOR UPDATE TO public;--> statement-breakpoint
CREATE POLICY "Users can insert their own works" ON "works" AS PERMISSIVE FOR INSERT TO public;--> statement-breakpoint
CREATE POLICY "Leaders can delete groups" ON "groups" AS PERMISSIVE FOR DELETE TO public USING ((leader_id IN ( SELECT user_profiles.id
   FROM user_profiles
  WHERE (user_profiles.root_account_id IN ( SELECT root_accounts.id
           FROM root_accounts
          WHERE (root_accounts.auth_user_id = auth.uid()))))));--> statement-breakpoint
CREATE POLICY "Leaders can update groups" ON "groups" AS PERMISSIVE FOR UPDATE TO public;--> statement-breakpoint
CREATE POLICY "Authenticated users can create groups" ON "groups" AS PERMISSIVE FOR INSERT TO public;--> statement-breakpoint
CREATE POLICY "Public read access for groups" ON "groups" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
CREATE POLICY "Public read access for nations" ON "nations" AS PERMISSIVE FOR SELECT TO public USING (true);--> statement-breakpoint
CREATE POLICY "Public read access for market items" ON "market_items" AS PERMISSIVE FOR SELECT TO public USING (true);--> statement-breakpoint
CREATE POLICY "Public read access for events" ON "nation_events" AS PERMISSIVE FOR SELECT TO public USING (true);--> statement-breakpoint
CREATE POLICY "Users can delete follows for their own profiles" ON "follows" AS PERMISSIVE FOR DELETE TO public USING ((follower_profile_id IN ( SELECT user_profiles.id
   FROM user_profiles
  WHERE (user_profiles.root_account_id IN ( SELECT root_accounts.id
           FROM root_accounts
          WHERE (root_accounts.auth_user_id = auth.uid()))))));--> statement-breakpoint
CREATE POLICY "Users can update follows for their own profiles" ON "follows" AS PERMISSIVE FOR UPDATE TO public;--> statement-breakpoint
CREATE POLICY "Users can create follows for their own profiles" ON "follows" AS PERMISSIVE FOR INSERT TO public;--> statement-breakpoint
CREATE POLICY "Users can view their profiles' followers (excluding watches)" ON "follows" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
CREATE POLICY "Users can view their own profiles' follows and watches" ON "follows" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
CREATE POLICY "Users can leave groups" ON "group_members" AS PERMISSIVE FOR DELETE TO public USING ((user_profile_id IN ( SELECT user_profiles.id
   FROM user_profiles
  WHERE (user_profiles.root_account_id IN ( SELECT root_accounts.id
           FROM root_accounts
          WHERE (root_accounts.auth_user_id = auth.uid()))))));--> statement-breakpoint
CREATE POLICY "Users can join groups" ON "group_members" AS PERMISSIVE FOR INSERT TO public;--> statement-breakpoint
CREATE POLICY "Leaders can remove members" ON "group_members" AS PERMISSIVE FOR DELETE TO public;--> statement-breakpoint
CREATE POLICY "Leaders can update members" ON "group_members" AS PERMISSIVE FOR UPDATE TO public;--> statement-breakpoint
CREATE POLICY "Leaders can add members" ON "group_members" AS PERMISSIVE FOR INSERT TO public;--> statement-breakpoint
CREATE POLICY "Public read access for group_members" ON "group_members" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
CREATE POLICY "Users can delete their own ratings" ON "user_work_ratings" AS PERMISSIVE FOR DELETE TO public USING ((auth.uid() = user_id));--> statement-breakpoint
CREATE POLICY "Users can update their own ratings" ON "user_work_ratings" AS PERMISSIVE FOR UPDATE TO public;--> statement-breakpoint
CREATE POLICY "Users can insert their own ratings" ON "user_work_ratings" AS PERMISSIVE FOR INSERT TO public;--> statement-breakpoint
CREATE POLICY "Users can view their own ratings" ON "user_work_ratings" AS PERMISSIVE FOR SELECT TO public;--> statement-breakpoint
CREATE POLICY "Users can delete their own entries" ON "user_work_entries" AS PERMISSIVE FOR DELETE TO public USING ((auth.uid() = user_id));--> statement-breakpoint
CREATE POLICY "Users can update their own entries" ON "user_work_entries" AS PERMISSIVE FOR UPDATE TO public;--> statement-breakpoint
CREATE POLICY "Users can insert their own entries" ON "user_work_entries" AS PERMISSIVE FOR INSERT TO public;--> statement-breakpoint
CREATE POLICY "Users can view their own entries" ON "user_work_entries" AS PERMISSIVE FOR SELECT TO public;
*/