...
// Refのモック
const mockAccountReference = { current: null };
const mockProfileReferences = { current: {} };
...
describe("IdentityVisualization", () => {
  const defaultProps = {
    ...
    accountRef: mockAccountReference as unknown as React.RefObject<HTMLDivElement>,
    profileRefs: mockProfileReferences as unknown as React.MutableRefObject<
