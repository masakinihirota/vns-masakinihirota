 ...
 * @param props.activeProfile
 * @param props.currentProfile
 * @param props.account
 * @param props.masks
 * @param props.linePath
 * @param props.accountRef
 * @param props.profileRefs
 * @param props.onProfileSelect
 * @param props.onCreateMask
 * @returns JSX.Element
 */
