...
interface VisibilityControlsProperties {
  readonly filters: FilterConfig;
  readonly onChange: (updater: (previous: FilterConfig) => FilterConfig) => void;
}
 ...
 */
export const VisibilityControls: React.FC<VisibilityControlsProperties> = ({
  filters,
  onChange,
}) => {
