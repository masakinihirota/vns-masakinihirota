...
describe("Step3IdentityPC", () => {
  ...
  it("should have no accessibility violations", async () => {
    const { container } = render(
      <Step3IdentityPC data={defaultData as any} onUpdate={mockOnUpdate} />
    );
  ...
  it("renders the age check question", () => {
    render(<Step3IdentityPC data={defaultData as any} onUpdate={mockOnUpdate} />);
  ...
  it("shows blocking message when is_minor is true", () => {
    render(
      <Step3IdentityPC
        data={{ ...defaultData, is_minor: true } as any}
