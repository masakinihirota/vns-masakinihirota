...
import { TrialFormData } from "../onboarding-trial-form/OnboardingTrialForm";

interface StepDeclarationsTrialProperties {
  data: TrialFormData;
  onUpdate: (data: Partial<TrialFormData>) => void;
}

export const StepDeclarationsTrial: React.FC<StepDeclarationsTrialProperties> = ({
  data,
  onUpdate,
}) => {
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
      <div className="space-y-2">
        ...
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
          VNSに参加するにあたり、以下の宣言を尊重してくれますか？
          <br />
          これは、私たちが互いに安心して共存するための大切な約束です。
        </p>
      </div>
