...
export const INITIAL_DATA: DashboardData = {
  ...
  works: [
    {
      id: 1,
      title: "Data Matrix 2026",
      category: "System",
      url: "https://vns.internal/dm26",
      rating: RATING_TYPES.TIER1,
    },
    {
      id: 2,
      title: "Neural Link UI",
      category: "Design",
      url: "https://vns.internal/nl-ui",
      rating: RATING_TYPES.TIER2,
    },
  ],
  favorites: [
    {
  ...
  values: [
    {
      id: 1,
      key: "効率性",
      description: "最小の労力で最大の情報密度を実現する",
      rating: RATING_TYPES.TIER1,
    },
    {
      id: 2,
      key: "透明性",
      description: "評価基準が常に明確であること",
      rating: RATING_TYPES.TIER2,
    },
    {
      id: 3,
      key: "自律性",
      description: "自ら課題を発見し、解決までのプロセスを設計する",
      rating: RATING_TYPES.TIER1,
    },
  ],
  skills: [
