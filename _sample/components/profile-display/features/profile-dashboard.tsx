...
interface ProfileDashboardProperties {
  ...
  readonly sortedWorks: readonly Work[];
  readonly filteredAndSortedFavs: readonly Favorite[];
  readonly pendingDelete: {
    readonly section: DashboardArrayKey;
    readonly id: number;
 ...
 * @param root0.filter
 * @param root0.visibleSections
 * @param root0.themeVars
 * @param root0.worksSort
 * @param root0.favsSort
 * @param root0.sortedWorks
 * @param root0.filteredAndSortedFavs
 * @param root0.pendingDelete
 * @param root0.onToggleTheme
 * @param root0.onToggleLikeMode
 * @param root0.onToggleFilter
 * @param root0.onToggleSection
 * @param root0.onSort
 * @param root0.onUpdateCell
 * @param root0.onRatingChange
 * @param root0.onAdd
 * @param root0.onDeleteTrigger
 * @param root0.onDeleteConfirm
 * @param root0.onDeleteCancel
 */
