...
export const Footer = () => {
  ...
  return (
    <footer className="pt-24 pb-12 border-t border-slate-200 dark:border-white/5 mt-24 animate-fade-in-up delay-600">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
        <div className="col-span-2 md:col-span-1 space-y-6">
          <Link
            href="/"
            className="text-2xl font-black italic tracking-tighter text-slate-900 dark:text-foreground"
          >
            VNS
          </Link>
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="p-2 rounded-full bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 text-slate-500 dark:text-muted-foreground hover:text-slate-900 dark:hover:text-foreground transition-all"
