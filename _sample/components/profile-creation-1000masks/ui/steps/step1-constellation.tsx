...
import { USER_BASE_CONSTELLATION } from "../../profile-creation-1000masks.constants";
import { Profile } from "../../profile-creation-1000masks.logic";
import { StepHeader } from "../step-header";

interface Step1ConstellationProperties {
...
export const Step1Constellation: React.FC<Step1ConstellationProperties> = ({
  activeProfile,
  onPrevAnonyms,
  onNextAnonyms,
  onSelectAnonym,
            ...
            return (
              ...
              >
                <div className="flex flex-col text-left">
                  <div
                    className={`text-lg font-black uppercase tracking-widest mb-1 ${isSel
                        ? (activeProfile.isGhost
