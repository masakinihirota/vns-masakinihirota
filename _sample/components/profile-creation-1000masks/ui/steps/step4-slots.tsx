...
import { ALL_SLOTS } from "../../profile-creation-1000masks.constants";
import { Profile, SlotId } from "../../profile-creation-1000masks.logic";
import { StepHeader } from "../step-header";

interface Step4SlotsProperties {
  activeProfile: Profile;
  onToggleSlot: (id: SlotId) => void;
}

export const Step4Slots: React.FC<Step4SlotsProperties> = ({
  activeProfile,
  onToggleSlot,
}) => {
  return (
        ...
        {ALL_SLOTS.map((slot) => {
          ...
          return (
            <button
              ...
              className={`flex items-center space-x-4 p-6 rounded-[2rem] border-2 transition-all ${isSelected
