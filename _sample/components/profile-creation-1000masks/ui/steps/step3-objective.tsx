...
import { ALL_SLOTS, OBJECTIVE_PRESETS } from "../../profile-creation-1000masks.constants";
import {
  ObjectiveId,
  Profile,
  SlotId,
...
interface Step3ObjectiveProperties {
...
export const Step3Objective: React.FC<Step3ObjectiveProperties> = ({
  activeProfile,
  onToggleObjective,
  onToggleSlot,
  error,
          ...
          <div className="flex flex-wrap gap-6 text-left">
            {ALL_SLOTS.map((slot) => {
              ...
              const sourceObjectives =
                activeProfile.selectedObjectiveIds.filter((objectId) => {
