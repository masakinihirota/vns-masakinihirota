...
interface PointManagementSectionProperties {
  data: RootAccount;
}

export const PointManagementSection: React.FC<PointManagementSectionProperties> = ({
  data,
}) => {
            ...
            <div className="flex items-center gap-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-4 border border-indigo-100 dark:border-indigo-800/50">
              ...
              <div>
                ...
                <div className="text-lg font-bold text-slate-900 dark:text-white">
                  +{nextRecoveryAmount.toLocaleString()}{" "}
                ...
                <div className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5 flex items-center gap-1">
                  ...
                  最終回復:{" "}
                  {new Date(data.last_recovery_at).toLocaleString("ja-JP")}
                </div>
              </div>
            </div>
          </div>
