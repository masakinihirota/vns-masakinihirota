 ...
 * @param root0.source
 */
export function WorkCard({ work, onClick, source = "db" }: WorkCardProperties) {
  const isAi = source === "ai";

  return (
    <div
      onClick={onClick}
      className={`group flex items-start gap-4 p-4 rounded-xl border cursor-pointer transition-all hover:shadow-md ${isAi
