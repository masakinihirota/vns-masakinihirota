...
type ProfileEvaluationsProperties = {
...
export const ProfileEvaluations: React.FC<ProfileEvaluationsProperties> = ({
  evaluations,
  onAdd,
  variant = "default",
  ...
  const renderTable = (
    ...
    headers.push({ label: "作品タイトル" }, { label: "操作", className: "w-10 text-right" });
