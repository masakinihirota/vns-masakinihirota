...
interface SortIconProperties {
  columnKey: SortConfig["key"];
  sortConfig: SortConfig;
}

// SortIcon コンポーネントを外部に抽出
const SortIcon = ({ columnKey, sortConfig }: SortIconProperties) => {
    ...
    <div className="h-full flex flex-col bg-gray-50 dark:bg-black/90">
      <div className="bg-white/70 dark:bg-black/40 px-4 border-b border-gray-200 dark:border-white/10 flex items-center gap-4 shrink-0 overflow-x-auto no-scrollbar backdrop-blur-sm">
        <button
          ...
          className={`py-3 px-2 text-[11px] font-bold ${activeSubTab === "matrix"
        ...
        <button
          ...
          className={`py-3 px-2 text-[11px] font-bold ${activeSubTab === "aggregation"
              ? "text-indigo-600 border-b-2 border-indigo-600 dark:text-indigo-400"
              : "text-gray-400"
            }`}
        >
        ...
        <button
          ...
          className={`py-3 px-2 text-[11px] font-bold ${activeSubTab === "detailed"
              ? "text-indigo-600 border-b-2 border-indigo-600 dark:text-indigo-400"
              : "text-gray-400"
            }`}
        >
              ...
              <table className="w-full text-[11px] border-collapse sticky-header">
                <thead className="sticky top-0 bg-gray-100/90 dark:bg-black/80 z-10 border-b border-gray-300 dark:border-white/20 backdrop-blur-md">
                  <tr className="divide-x divide-gray-200 dark:divide-white/10">
                    ...
                    >
                      作品名 <SortIcon columnKey="title" sortConfig={sortConfig} />
                    </th>
                    <th
                    ...
                    >
                      自分 <SortIcon columnKey="me" sortConfig={sortConfig} />
                    </th>
                    <th
                    ...
                    >
                      {selectedMember.name} <SortIcon columnKey="target" sortConfig={sortConfig} />
                    </th>
                  ...
                  {sortedWorks.map((work) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td
                          className={`p-1.5 text-center font-bold ${myRating === "T1"
                        ...
                        <td
                          className={`p-1.5 text-center font-bold ${targetRating === "T1"
                              ? "text-amber-600"
                              : "text-gray-400"
                            }`}
                        >
