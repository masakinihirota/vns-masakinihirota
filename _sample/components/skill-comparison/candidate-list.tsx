...
interface CandidateListProperties {
 ...
 * @param root0.selectedTargetId
 * @param root0.onSelectTarget
 * @param root0.onToggleAction
 * @param root0.actionType
 * @param root0.countBadge
 * @param root0.showDetails
 */
export const CandidateList: React.FC<CandidateListProperties> = ({
  title,
  icon,
  candidates,
  focusedSkill,
