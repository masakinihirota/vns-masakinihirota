...
interface WorkRegistrationProperties {
 ...
 * @param root0.onFillDummyData
 * @param root0.requiredPoints
 */
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          {/* Validation message is handled at container level */}
                        </FormItem>
                      )}
                    />
                  </CardContent>
