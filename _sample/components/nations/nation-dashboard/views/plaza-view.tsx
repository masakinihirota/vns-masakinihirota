  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                  <div className="flex justify-between items-start">
                    <div className="flex gap-2">
                      ...
                      <span
                        className={`text-xs px-2 py-0.5 rounded-full ${post.role === "King"
        ...
        <div className="space-y-4">
          <div className="bg-white dark:bg-white/5 dark:border-white/10 rounded-xl shadow-sm border border-gray-200 p-4">
            <h3 className="font-bold text-gray-700 dark:text-gray-200 mb-3 text-sm border-b dark:border-white/10 pb-2">
              現在のデータ
            </h3>
            ...
            <div className="grid grid-cols-2 gap-2 mb-2">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-2 rounded text-center">
                ...
                <div className="font-bold text-blue-800 dark:text-blue-200">
                  {(NATION_DATA.treasury / 10_000).toFixed(1)}万pt
                </div>
              </div>
            </div>
