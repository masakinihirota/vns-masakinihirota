...
interface Step4FavoriteWorksProperties {
                    ...
                    <div className="flex gap-1 bg-slate-100 dark:bg-slate-700 p-0.5 rounded-md">
                      {[1, 2, 3, "normal"].map((t) => (
                        <button
                          key={t}
                          onClick={() =>
                            setWorkTier(work.id, activePeriod, t as 1 | 2 | 3 | "normal")
                          }
                ...
                {WORK_CATEGORIES.map((cat) => {
                  ...
                  return (
                    <button
                      key={cat}
                      onClick={() => {
                        setFilterCategories((previous) =>
                          isSelected
                            ? previous.filter((c) => c !== cat)
                            : [...previous, cat]
                        );
                      }}
                ...
                {ERAS.map((era) => {
                  ...
                  return (
                    <button
                      key={era}
                      onClick={() => {
                        setFilterEras((previous) =>
                          isSelected
                            ? previous.filter((e) => e !== era)
                            : [...previous, era]
                        );
                      }}
