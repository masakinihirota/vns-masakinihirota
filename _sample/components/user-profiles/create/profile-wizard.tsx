...
import { UpdateWizardData, WizardData } from "./user-profile-creation.types";
...
export const ProfileWizard = () => {
  ...
  const updateData: UpdateWizardData = (key, value) => {
    setData((previous) => ({ ...previous, [key]: value }));
  };

  const nextStep = () => setStep((previous) => Math.min(previous + 1, 3));
