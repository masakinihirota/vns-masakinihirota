...
/**
 * プロフィール作成ウィザード（ProfileWizard）用の一時データ構造
 */
...
/**
 * プロフィール作成ウィザード用のデータ更新関数型
 */
export type UpdateWizardData = (key: keyof WizardData, value: string) => void;

/**
 * フォームデータの更新関数型
 */
export type UpdateForm = <K extends keyof UserProfile>(
  key: K,
  value: UserProfile[K]
) => void;
