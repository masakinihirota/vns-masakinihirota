...
export default function CreateProfilePage() {
  ...
  useEffect(() => {
    ...
    if (globalThis.window !== undefined) {
      const isTrialConfig = globalThis.localStorage.getItem("homeTrialConfig");
  ...
  const handleComplete = async (formData: unknown) => {
    ...
    try {
      ...
      const createData: CreateProfileData = {
        ...
        role_type: data.role.toLowerCase(), // Leader/Member -> leader/member
        role: data.role.toLowerCase() as "leader" | "member",
