...
export const marketItems = pgTable("market_items", {
  ...
  sellerId: uuid("seller_id").references(() => userProfiles.id, {
    onDelete: "set null",
  }),
  sellerGroupId: uuid("seller_group_id").references(() => groups.id, {
    onDelete: "set null",
  }),
...
export const marketTransactions = pgTable("market_transactions", {
  ...
  buyerId: uuid("buyer_id").references(() => userProfiles.id, {
    onDelete: "set null",
  }),
  price: numeric("price").notNull(),
