...
const GLOSSARY_ITEMS = [
  ...
  {
    id: "no-ban-drift",
    term: "No BAN, Just Drift",
    category: "concept",
    categoryLabel: "理念・基本",
    description:
      "ルール違反者を削除して口を塞ぐのではなく、コミュニティからの「居場所」を失わせて漂流させる（Drift）というVNSのアプローチ。",
    details: [
      "「発言権は奪わないが、聞く義務も負わない」というスタンスを基本とします。",
      "不適切なユーザーをBAN（存在の消去）するのではなく、誰もその発言を観測しない「孤立した空間」へと自然に遷移させます。",
      "これにより、言論弾圧を行うことなく、善良なユーザーの「平穏な世界」を保護します。",
    ],
  },
