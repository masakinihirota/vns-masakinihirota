...
<a key="privacy-link" href="/privacy" className="text-indigo-600 hover:text-indigo-800 font-bold flex items-center mt-4 transition-colors">
...
<a href="/" className="flex items-center text-xl font-extrabold text-indigo-600 tracking-wider">
...
© 2024 VNS masakinihirota. All rights reserved. | <a href="/privacy" className="hover:underline">プライバシーポリシー</a>
</div>
</footer>
);
                    ...
                    <div className="space-y-8 sm:space-y-10">
                        {TERMS_CONTENT.map((section, index) => (
                            <section key={index} className="space-y-4 md:space-y-5">
                                ...
                                <div className="text-sm sm:text-base leading-relaxed text-gray-700 space-y-3">
                                    {section.content.map((item, itemIndex) => {
                                        ...
                                        if (Array.isArray(item)) {
                                            // 禁止事項などのリスト
                                            return (
                                                <ul key={itemIndex} className="list-disc pl-5 space-y-1 mt-2">
