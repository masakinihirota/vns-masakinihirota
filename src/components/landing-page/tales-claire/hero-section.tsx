  ...
  return (
    <header className="flex flex-col items-center text-center space-y-8 min-h-[60vh] justify-center animate-fade-in-up">
      <div className="space-y-4">
        <div className="inline-flex items-center rounded-full border px-3 py-1 text-sm font-semibold border-blue-500/20 bg-blue-500/10 text-blue-600 dark:text-blue-400">
          MVP版
        </div>
      ...
      <h2 className="text-2xl md:text-3xl font-light leading-relaxed font-serif bg-gradient-to-br from-indigo-800 to-blue-600 dark:from-white dark:to-indigo-300 bg-clip-text text-transparent max-w-3xl drop-shadow-sm dark:drop-shadow-none">
      ...
      <div className="space-y-4 font-serif">
        ...
        <p className="text-lg md:text-xl text-slate-600 dark:text-muted-foreground max-w-2xl px-4">
