...
export default function Component() {
        ...
        return (
          <Card className="w-[350px]">
            <CardHeader>
              ...
              <CardDescription>プロフィールの目的を選択してください</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        return (
          <Card className="w-[350px]">
            <CardHeader>
              ...
              <CardDescription>リーダーシップスタイルを選択してください</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        return (
          <Card className="w-[350px]">
            <CardHeader>
              ...
              <CardDescription>興味のあるカテゴリを選択してください</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        return (
          <Card className="w-[350px]">
            <CardHeader>
              ...
              <CardDescription>あなたの価値観を選択してください (1/3)</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col space-y-2">
                <Checkbox
        ...
        return (
          <Card className="w-[350px]">
            <CardHeader>
              ...
              <CardDescription>ユーザープロフィールが作成されました</CardDescription>
            </CardHeader>
            <CardContent>
              <p>目的: {purpose}</p>
            ...
            <CardFooter>
              <Button onClick={() => console.log('プロフィール保存')}>保存して終了</Button>
            </CardFooter>
          </Card>
        )
      default:
  ...
  return <div className="flex justify-center items-center min-h-screen">{renderStep()}</div>
}
