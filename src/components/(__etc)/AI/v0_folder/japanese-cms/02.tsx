...
import { Button } from "../digital-agency-design-system"
	...
	return (
		<div className='max-w-2xl mx-auto p-6 text-gray-900 dark:text-gray-100'>
			...
			<div className='flex justify-between items-center mb-4'>
				<Button className='bg-transparent text-blue-600 dark:text-blue-400 hover:underline px-0 py-0'>
					&lt; 戻る
				</Button>
				<Button className='bg-transparent text-blue-600 dark:text-blue-400 hover:underline px-0 py-0'>
					次へ &gt;
					...
					<div key={choice} className='flex items-center justify-between py-1'>
						...
						{i >= 3 && (
							<span className='flex items-center gap-1 text-xs text-gray-500 dark:text-gray-400'>
								登録ユーザー名
								<FaTrashAlt className='inline-block text-gray-400 dark:text-gray-500 cursor-pointer' />
							</span>
						)}
					</div>
				))}
				<Button className='bg-transparent text-blue-600 dark:text-blue-400 hover:underline px-0 py-0 text-xs'>
					+追加の選択肢
				</Button>
			</div>
			{/* カード2つ */}
