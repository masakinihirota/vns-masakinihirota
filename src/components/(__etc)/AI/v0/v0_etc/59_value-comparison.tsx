...
export default function Component() {
	const [currentTopic, _setCurrentTopic] = useState("人生で大切なのは")
		...
		<Card className='w-full max-w-4xl mx-auto bg-gray-50'>
			...
			<CardContent className='p-6 bg-white'>
				...
				<div className='flex justify-between items-center mb-4'>
					...
					<h2 className='text-2xl font-bold text-gray-800'>自分</h2>{" "}
					{/* テキスト色を変更 */}
					<Button variant='outline' size='icon' className='text-gray-700'>
						{" "}
						{/* ボタンの色を変更 */}
					...
					<h2 className='text-2xl font-bold text-gray-800'>相手</h2>{" "}
					{/* テキスト色を変更 */}
					<Button variant='outline' size='icon' className='text-gray-700'>
						{" "}
						{/* ボタンの色を変更 */}
				...
				<div className='grid grid-cols-[1fr,auto,auto] gap-2'>
					<div></div>
					<div className='text-center font-bold text-gray-800'>自分</div>{" "}
					{/* テキスト色を変更 */}
					<div className='text-center font-bold text-gray-800'>相手</div>{" "}
					{/* テキスト色を変更 */}
					{valueItems.map((item) => (
