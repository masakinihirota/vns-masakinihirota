    ...
    {ALL_SLOTS.map((slot) => {
      ...
      return (
        <button
          ...
          className={`flex items-center space-x-4 p-5 rounded-[1.5rem] border-2 transition-all ${
            isSelected
        ...
        >
          <div
            className={isSelected ? "text-[var(--accent)]" : "text-slate-300"}
          >
          ...
          <div className="flex items-center space-x-3">
            <slot.icon
              size={20}
              className={isSelected ? "text-[var(--accent)]" : "opacity-40"}
            />
