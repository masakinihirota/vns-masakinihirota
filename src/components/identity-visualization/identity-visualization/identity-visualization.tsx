        ...
        <div className="flex w-full max-w-6xl justify-around items-center relative z-10 px-6 md:px-12">
          ...
          <div className="flex flex-col items-center gap-8">
            <div className="relative group">
              ...
              <div
                ref={accountRef}
                className={`w-48 h-48 rounded-full border-4 flex items-center justify-center shadow-2xl relative transition-all duration-700 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl overflow-hidden ${
                  isGhost
          ...
          <div className="flex flex-col gap-6 w-96">
            ...
            <div className="relative">
              ...
              <button
                ...
                className={`w-full p-4 rounded-[2rem] border-2 flex items-center gap-5 transition-all duration-500 group shadow-xl ${
                  isGhost
                ...
                return (
                  <div key={mask.id} className="relative">
                    ...
                    <button
                      ...
                      className={`w-full p-3.5 rounded-2xl border-2 flex items-center gap-5 transition-all duration-500 group shadow-lg backdrop-blur-md ${
                        isActive
