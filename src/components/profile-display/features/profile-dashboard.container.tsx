...
export const ProfileDashboardContainer = () => {
  ...
  // テーマ変数の計算
  const themeVars: ThemeVars = useMemo(() => isDarkMode ? {
    bg: 'bg-[#0B0F1A]',
    text: 'text-neutral-200',
    subText: 'text-neutral-400',
    card: 'bg-white/5 backdrop-blur-md border-white/10 shadow-2xl',
    accent: 'text-indigo-400',
    btnPrimary: 'bg-white/10 hover:bg-white/15 text-neutral-100 border-white/20',
    ...
    btnPrimary: 'bg-white/40 hover:bg-white/60 text-blue-900 border-white/50',
