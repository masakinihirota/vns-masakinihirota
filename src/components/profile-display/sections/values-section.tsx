...
import { CoreValue, RatingType, ThemeVars } from '../features/profile-dashboard.types';
  ...
  <section className={`rounded-2xl ${themeVars.card} border overflow-hidden`}>
    ...
    <div className="overflow-x-auto">
      <table className="w-full border-collapse">
        ...
        <tbody>
          {values.map(v => (
            <tr key={v.id} className={`border-b border-white/5 transition-colors ${themeVars.rowHover} group`}>
              <EditableCell
                value={v.key}
